...
public class XmlRessourceLoader {
    ...
    public static ArrayList<Item> loadStockData(Application app) {
        Log.i(TAG,"Starting loadStocksData");
                ...
                switch (event){
                    ...
                    case XmlPullParser.END_TAG:
                        switch (tag){
                            case "item":
                                Log.d(TAG,"new item");
                                items.add(new Item(itemName,itemPrice, itemRessource, itemStock));
    ...
    public static HashMap<String,ArrayList<Item>> loadRetrunData(Application app) {
        Log.i(TAG,"Starting loadReturnData");
        AssetManager assetManager = app.getAssets();
